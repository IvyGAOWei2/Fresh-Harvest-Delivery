...
INSERT INTO Unit (unit_name) VALUES ('Bunch'), ('Weight'), ('Each'), ('Half-size'), ('Punnet'), ('Tray'), ('kg'), ('g');
...
('Carrots', 'Carrots are a versatile and essential kitchen staple, known for their sweet flavor and crisp texture. Rich in beta-carotene, vitamins, and minerals, they are a healthy choice for any meal. Enjoy them raw as a snack, juiced for a refreshing drink, or cooked in stews, soups, and roasts. Each kilogram of carrots promises a boost of color and nutrition, making them a favorite for both cooking and baking.', 1.20, 100, 2, 7, 1),
('Brown Onions', 'Brown Onions are a fundamental ingredient in many dishes, valued for their strong, pungent flavor that sweetens upon cooking. These onions are perfect for adding depth to soups, stews, sauces, and sautéed dishes. Each kilogram of brown onions provides layers of flavor, enhancing your cooking with their rich, caramel-like sweetness when cooked and a sharp bite when served raw.', 0.88, 100, 2, 7, 1),
...
('Parsnips', 'Parsnips are a root vegetable similar to carrots but with a sweeter and earthier flavor. They are perfect for roasting, making into creamy soups, or mashing with potatoes for a delicious twist on a classic side. Rich in fiber and potassium, parsnips provide a healthy boost to any meal. Each kilogram of parsnips is ready to bring a subtle sweetness to your cooking.', 3.00, 100, 2, 8, 1),
...
("Ginger Imported", "Imported ginger offers a pungent, spicy flavour and aromatic fragrance, making it a versatile ingredient in both sweet and savoury dishes. Whether used fresh, dried, or powdered, ginger adds warmth and depth to curries, stir-fries, marinades, teas, and baked goods.", 12.99,100,3,8,1);
